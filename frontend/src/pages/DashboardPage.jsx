  ...
  Particles.init({
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">Welcome to Blogger the best AI blog gen website</h1>
...
<section class="bg-white dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <img class="w-full hidden dark:block" src="https://images.pexels.com/photos/1558690/pexels-photo-1558690.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="dashboard image"></img>
    ...
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div class="mt-4 md:mt-0">
            ...
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Our goal always has been to provide our users with a high quality user experience we aim to provide oue users a clean and smooth user experience and make a smooth and easy to understand experience for oue users.</p>
        </div>
        <img class="w-full hidden dark:block" src="https://cdn.vectorstock.com/i/2000v/73/96/our-goals-list-card-with-colorful-brush-strokes-vector-21757396.avif" alt="dashboard image"></img>
    </div>
    <section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/thomas-lean.png" alt="Leslie Avatar"></img>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="Michael Avatar"></img>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
